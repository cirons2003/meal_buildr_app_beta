    ...
    return (
        ...
        {selectedMeal  && (
            ...
            right = '-900px' bg = 'teal'  minHeight = '350px'>
                ...
                <PopoverCloseButton bg = 'white' color = 'red' onClick = {() => setSelectedMeal(null)} />
                <PopoverHeader color = 'white' as = 'b' fontSize = '25px'>{new Date(selectedMeal.logged_at).toLocaleTimeString()}</PopoverHeader>
                ...
                <Flex alignItems = 'center' mb = '20px' mt = '20px' bg = '' >
                    <Input  type = 'text' fontSize = '20px' color = 'teal' placeholder = 'comment' bg ='white' />
                    <IconButton icon = {<ArrowForwardIcon/>}  bg = 'orange' />
                </Flex>
                </PopoverBody>
            </PopoverContent>
            </Popover>
